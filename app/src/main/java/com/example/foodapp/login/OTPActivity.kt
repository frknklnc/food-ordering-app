...
import com.example.foodapp.databinding.ActivityOtpactivityBinding
...
class OTPActivity : AppCompatActivity() {
    ...
    private lateinit var buttonDogrula : Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonDogrula.setOnClickListener {
            // tüm edittextler dolu
            val typedOTP = (inputOTP1.text.toString() + inputOTP2.text.toString()
                            + inputOTP3.text.toString()+ inputOTP4.text.toString() + inputOTP5.text.toString() + inputOTP6.text.toString())
            ...
            if (typedOTP.isNotEmpty()){
                if (typedOTP.length == 6){
                    ...
                    Toast.makeText(this,"Lütfen doğrulama kodunu doğru giriniz", Toast.LENGTH_SHORT).show()

                }
            }else{Toast.makeText(this,"Lütfen doğrulama kodunu giriniz", Toast.LENGTH_SHORT).show()
    ...
    private fun init(){
        ...
        buttonDogrula = binding.buttonDogrula
